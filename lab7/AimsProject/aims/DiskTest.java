...
public class DiskTest {
    public static void main(String [] args){
        ...
        newOrder.addMedia(dvdList[0]);
        newOrder.addMedia(dvdList[1]);
        newOrder.addMedia(dvdList[2]);
        newOrder.addMedia(dvdList[3]);
        newOrder.addMedia(dvdList[4]);
        newOrder.addMedia(dvdList[5]);
        System.out.println();
